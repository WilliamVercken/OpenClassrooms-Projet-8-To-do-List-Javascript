...
describe('controller', function() {
    ...
    describe('routing', function() {
        ...
        it('should call model to read completed entries', function() {
            // SPEC: NEW, NEED REVIEW
            var todo = [{
                id: 1,
                title: 'Todo 1',
    ...
    describe('toggle all', function() {
        it('should toggle all todos to completed', function() {
            ...
            expect(model.update).toHaveBeenCalledWith(3, {
                completed: true
            }, jasmine.any(Function));
        });
    ...
    describe('new todo', function() {
        it('should add a new todo to the model', function() {
            ...
            view.trigger('newTodo', 'Todo 2');

            expect(model.create).toHaveBeenCalledWith('Todo 2', jasmine.any(Function));
        });
